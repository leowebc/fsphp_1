...
if (!file_exists($file) || !is_file($file)){
    ...
    fwrite($fileOpen, "O Lorem Ipsum é um texto modelo da indústria tipográfica e de impressão. O Lorem Ipsum tem vindo a ser o texto padrão usado por estas indústrias " . PHP_EOL);
    fclose($fileOpen);
}else{
    var_dump(
        file($file),
